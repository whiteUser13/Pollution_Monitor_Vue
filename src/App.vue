<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            <div class="text-2xl font-bold text-green-600">
              {{ store.statistics?.activePoints || 0 }}
            </div>
    ...
    <div class="flex h-[calc(100vh-80px)]">
      <!-- 左侧导航栏 -->
      <div class="w-64 bg-white/80 backdrop-blur-sm shadow-sm border-r flex flex-col">
      ...
      <div class="flex-1 flex flex-col">
        ...
        <template v-if="store.activeTab === 'orders'">
          <!-- 工单管理区域 -->
          <div class="flex-1 p-4">
            <WorkOrderManagement :work-order-stats="store.statistics?.workOrderStats"
      ...
      <!-- 右侧信息栏 -->
      <div class="w-80 bg-white/80 backdrop-blur-sm shadow-sm border-l flex flex-col">
        <div class="p-4 border-b">
          <h2 class="text-sm font-semibold text-gray-700 flex items-center">
            <Activity class="h-4 w-4 mr-2" />
            系统状态
